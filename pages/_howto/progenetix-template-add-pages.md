...
New pages are added to the website inside one of the "collections" directories in the `/{{site.collections_dir}}` directory. This can either be done by adding files locally or on Github (if hosted there).
