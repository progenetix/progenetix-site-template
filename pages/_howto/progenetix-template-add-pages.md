...
If the website is hosted on Github, normal pages (i.e. not the listing pages for `tags` and `categories`) can be edited using Github's online editor. A direct link is provided through an "edit" icon which should be visible in the lower right corner of the page. <a href="{{github_link}}{{page.path}}"><img src="{{ 'assets/img/icons8-edit-file-26.png' | relative_url }}" alt="Edit on Github..."  style="position: float: right;" /></a> Clicking this will open the page's source code in the Github editor; however, to change the code one still needs to click on the "edit" icon of the editor's menu bar.
